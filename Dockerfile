...
WORKDIR /root
RUN mvn package
RUN java -Djarmode=layertools -jar /root/target/IMMPlaH-0.0.1-SNAPSHOT.jar list
RUN java -Djarmode=layertools -jar /root/target/IMMPlaH-0.0.1-SNAPSHOT.jar extract
RUN ls -l /root
